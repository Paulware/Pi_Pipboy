...
?>
  ...
  function selectTeam (ID, TeamColor) {
     var msg = 'setTeam.php?OwnerId=' + ID + '&TeamColor=' + TeamColor;
   ...
   if ($User != 'admin') { // Normal player
      ...
      while ($row = mysql_fetch_assoc ($result)) {		
         ...
         if (($Typename == "Player") && ($Team != ''))  {         
            ...
            $Team = $row["Team"];            
            print ("<tr>");
            print ("<td align=\"center\"><input type=\"button\" value=\"$Username\" onclick=\"window.location.href='pip.php?OwnerId=$OwnerId'\"></td><td align=\"center\">$MAC</td><td align=\"center\">$IpAddress</td><td align=\"center\">$Message</td>");
...
<input type="button" value="Free For All" onclick="window.location.href='ffa.php';"><br>    
<input type="button" value="Team Deathmatch" onclick="window.location.href='TDM.php';"><br>   
