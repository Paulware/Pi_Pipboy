...
<?php 
  ...
  $sql = "CREATE TABLE inventory (ID INT AUTO_INCREMENT PRIMARY KEY, ItemId INT, OwnerId INT, Quantity INT, ForSale BOOL DEFAULT 0, InVault BOOL DEFAULT 0, Price INT DEFAULT 100)";  
  $result = mysql_query ($sql) or die ("Could not execute: $sql");  
